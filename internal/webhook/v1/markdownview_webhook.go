...
// +kubebuilder:webhook:path=/mutate-view-kumashun8-github-io-v1-markdownview,mutating=true,failurePolicy=fail,sideEffects=None,groups=view.kumashun8.github.io,resources=markdownviews,verbs=create;update,versions=v1,name=mmarkdownview-v1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-view-kumashun8-github-io-v1-markdownview,mutating=false,failurePolicy=fail,sideEffects=None,groups=view.kumashun8.github.io,resources=markdownviews,verbs=create;update,versions=v1,name=vmarkdownview-v1.kb.io,admissionReviewVersions=v1
